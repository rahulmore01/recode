      ...
      <div className="flex flex-col justify-center items-center gap-12">
        ...
        <div className="flex  mlg:flex-col justify-center items-center SpaceMonoRegular text-[14px] mlg:text-[15px] !text-lightGray w-full border-collapse   text-center mlg:text-start ">
          <div className="flex flex-col mlg:flex-row">
            <div className="  border border-dashed p-4 border-skyBlue w-[170px] h-[210px] mlg:h-[140px] mlg:w-[300px] lg:h-[140px] lg:w-[400px] rounded-tl-[16px]  flex flex-col mlg:flex-row   justify-center items-center gap-2 mlg:gap-8 ">
            ...
            <div className="  border border-dashed p-4 border-skyBlue w-[170px] h-[210px] mlg:h-[140px] mlg:w-[300px] lg:h-[140px] lg:w-[400px]  flex flex-col mlg:flex-row   justify-center items-center gap-2 mlg:gap-8 ">
              <p className="text-darkGray text-[14px] mlg:text-[15px] primary px-[23px] py-[17px]  border-[3px]  border-darkPink bg-skyBlue rounded-full ">
                2
              </p>
              <span className="w-full max-w-[208px]">
            ...
            <div className="  border border-dashed p-4 border-skyBlue w-[170px] h-[210px] mlg:h-[140px] mlg:w-[300px] lg:h-[140px] lg:w-[400px]  flex flex-col mlg:flex-row   justify-center items-center gap-2 mlg:gap-8 rounded-bl-[16px] mlg:rounded-bl-none mlg:rounded-tr-[16px]">
              <p className="text-darkGray text-[14px] mlg:text-[15px] primary px-[23px] py-[17px]  border-[3px]  border-darkPink bg-skyBlue rounded-full ">
                3
              </p>
              <span className="w-full max-w-[208px]">
          ...
          <div className="flex flex-col mlg:flex-row">
            <div className="  border border-dashed p-4 border-skyBlue w-[170px] h-[210px] mlg:h-[140px] mlg:w-[300px] lg:h-[140px] lg:w-[400px] rounded-tr-[16px] mlg:rounded-tr-none  mlg:rounded-bl-[16px] flex flex-col mlg:flex-row   justify-center items-center gap-2 mlg:gap-8 ">
              <p className="text-darkGray text-[14px] mlg:text-[15px] primary px-[23px] py-[17px]  border-[3px]  border-darkPink bg-skyBlue rounded-full ">
                4
              </p>
              <span className="w-full max-w-[208px]">
            ...
            <div className="  border border-dashed p-4 border-skyBlue w-[170px] h-[210px] mlg:h-[140px] mlg:w-[300px] lg:h-[140px] lg:w-[400px]  flex flex-col mlg:flex-row   justify-center items-center gap-2 mlg:gap-8 rounded-br-[16px]">
              <p className="text-darkGray text-[14px] mlg:text-[15px] primary px-[23px] py-[17px]  border-[3px]  border-darkPink bg-skyBlue rounded-full ">
                6
              </p>
